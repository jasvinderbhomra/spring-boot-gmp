...
//	// 			"<bd:getProductRequest xmlns:bd=\"http://baeldung.com/spring-boot-web-service\">" + "<bd:id>1</bd:id>"
//	// 					+ "</bd:getProductRequest>");
//	// 	StringSource response = new StringSource(
//	// 			"<bd:getProductResponse xmlns:bd=\"http://baeldung.com/spring-boot-web-service\">" + "<bd:product>"
//	// 					+ "<bd:id>1</bd:id>" + "<bd:name>Product 1</bd:name>" + "</bd:product>"
